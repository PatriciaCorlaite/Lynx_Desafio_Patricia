$(document).ready(function ($) {
    ...
    function CarregaGridSubCategorias(Codigo) {
        ...
        $.ajax({
            type: "GET",
            url: "/ProdutoMoveis/BuscarSubCategorias/",
    ...
    function CarregaGridCategorias() {
      //alert("Aqui");
        ...
        $.ajax({
            type: "GET",
            url: "/ProdutoMoveis/BuscarCategorias/",
            dataType: "json",
            success: function (json) {
        ...
        $.getJSON('/ProdutoMoveis/Buscar/',
          ...
          function (json) {
              ...
              $.each(json, function (i, EmpData) {
                  ...
                  tr.append("<th>" + EmpData.Cor + "</th>");
                  tr.append("<th>" + EmpData.Tamanho + "</th>");
                  
                  
                  tr.append("<th width='40px'><input type='text' id='Estoque' class='form-control' value='" + EmpData.qty + "' name='Estoque-"+EmpData.sku +"' maxlength='70'></th>");
                  //tr.append("<th>" + EmpData.qty + "</th>");
                  tr.append("<th width='100px'><input type='text' id='Preco' class='form-control' value='" + parseFloat(EmpData.promotional_price).toFixed(2) + "' name='Preco-" + EmpData.sku + "' maxlength='70'></th>");

                  tr.append("<th>" + "<a id='deletar' class='confirmation-callback' href=/ProdutoMoveis/Edit/" + EmpData.sku + ">Editar</a>" + "</th>");
