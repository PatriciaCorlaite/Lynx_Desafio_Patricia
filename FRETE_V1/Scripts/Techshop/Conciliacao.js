$(document).ready(function () {
    ...
    if ($('#DataInicioRetorno').val() != undefined) {

        $("#DataInicio").val($('#DataInicioRetorno').val());
      
    }

    if ($('#DataFimRetorno').val() != undefined) {

        $("#DataFim").val($('#DataFimRetorno').val());

    }

   /* <input type="hidden" name="DataInicioRetorno" value="@ViewBag.DataInicio" id="DataInicioRetorno"> 
 <input type="hidden" name="DataFimRetorno" value="@ViewBag.DataFim" id="DataFimRetorno"> */
